...
module.exports = function(grunt) {
    ...
    pkg: grunt.file.readJSON('package.json'),
		...
		sass: {                              // Task 
			...
			dark: {                            // Target 
				...
				files: {                         
					'public/dist/css/style.css': 'src/scss/style-dark.scss',       // 'destination': 'source' 
				}
			},
			rtl: {                            // Target 
				options: {                       // Target options 
				...
				files: {                         
					'public/dist/css/style.css': 'src/scss/style-rtl.scss',       // 'destination': 'source' 
				}
			},
			rtldark: {                            // Target 
				options: {                       // Target options 
				...
				files: {                         
					'public/dist/css/style.css': 'src/scss/style-rtl-dark.scss',       // 'destination': 'source' 
				}
			}
		},
		cssmin: {
  ...
  // Register all Tasks.
  grunt.registerTask('default',  ['sass:dist','jshint:all']);
